...
class SwitcherWeb(App):
    ...
    def idle(self):
        ...
        if tally_1 == "[PGM]":
            ...
            self.tally1.css_background_color = "rgb(245,0,0)"
        elif tally_1 == "[PVW]":
            self.src1.css_background_color = "rgb(80,164,0)"
            self.tally1.css_background_color = "rgb(80,164,0)"
        elif tally_1 == "[]":
        ...
        if tally_2 == "[PGM]":
            ...
            self.tally2.css_background_color = "rgb(245,0,0)"
        elif tally_2 == "[PVW]":
            self.src2.css_background_color = "rgb(80,164,0)"
            self.tally2.css_background_color = "rgb(80,164,0)"
        elif tally_2 == "[]":
        ...
        if tally_3 == "[PGM]":
            ...
            self.tally3.css_background_color = "rgb(245,0,0)"
        elif tally_3 == "[PVW]":
            self.src3.css_background_color = "rgb(80,164,0)"
            self.tally3.css_background_color = "rgb(80,164,0)"
        elif tally_3 == "[]":
        ...
        if tally_4 == "[PGM]":
            ...
            self.tally4.css_background_color = "rgb(245,0,0)"
        elif tally_4 == "[PVW]":
            self.src4.css_background_color = "rgb(80,164,0)"
            self.tally4.css_background_color = "rgb(80,164,0)"
        elif tally_4 == "[]":
    ...
    def construct_ui(self):
        ...
        self.Switcher.css_display = "none"
        self.Switcher.css_height = "89%"
        self.Switcher.css_left = "1px"
        self.Switcher.css_position = "absolute"
        self.Switcher.css_top = "66px"
